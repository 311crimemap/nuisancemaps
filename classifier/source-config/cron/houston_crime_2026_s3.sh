...
URL=https://www.houstontx.gov/police/cs/xls/NIBRSPublicView2026.csv
FILE=NIBRSPublicView2026.csv

date
echo "[houston_crime_2026_s3] Downloading File"
...
echo "[houston_crime_2026_s3] Uploading to AWS"
