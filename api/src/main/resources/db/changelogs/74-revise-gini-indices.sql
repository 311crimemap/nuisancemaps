...
CREATE INDEX IF NOT EXISTS idx_point_gist_data_311 ON data_311 USING GIST(point);

-- changeset root:1776823299790-2
CREATE INDEX IF NOT EXISTS idx_point_gist_data_crime ON data_crime USING GIST(point);

-- changeset root:1776823299790-3
DROP INDEX IF EXISTS idx_gist_point_reported_at_data_crime;

-- changeset root:1776823299790-4
DROP INDEX IF EXISTS idx_gist_point_reported_at_data_311;
