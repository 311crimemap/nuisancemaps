...
export default function Terms() {
  return (
    <article className="prose">
      ...
      <p>
        We operate the website 311crimemap.com (the "Site"), as well as any
        other related products and services that refer or link to these legal
        terms (the "Legal Terms") (collectively, the "Services").
      </p>

      <p>
        A cloud-based online map displaying historical 311 requests and police
        incident reports across select cities.
      </p>

      <p>You can contact us by email at admin@311crimemap.com.</p>
      <p>
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ("you"), and 311 Crime
        Map, concerning your access to and use of the Services. You agree that
      ...
      <p>
        ...
        address your request to: admin@311crimemap.com. If we ever grant you the
