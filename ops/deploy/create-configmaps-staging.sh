...
envsubst '${PGBACKREST_REPO2_S3_REGION} ${PGBACKREST_REPO2_S3_ENDPOINT} ${PGBACKREST_REPO2_S3_BUCKET}' < staging/postgresql/pgbackrest-configmap.yml | kubectl apply -f -
